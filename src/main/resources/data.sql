...
INSERT INTO car(ID, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, CONVERTIBLE, COLOR, MODEL)
VALUES(1, now(), false, 'ELECTRIC', 'GA1234', 5.0, 4, 'HUINDAI', false,'RED', '2017');

INSERT INTO car(ID, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, CONVERTIBLE, COLOR, MODEL)
VALUES(2, now(), false, 'GAS', 'KA4567', 3.0, 2, 'AUDI', false,'WHITE', '2018');

INSERT INTO car(ID, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, CONVERTIBLE, COLOR, MODEL)
VALUES(3, now(), false, 'HYBRID', 'JF3455', 5.0, 2, 'BENZ', true,'WHITE', '2018');